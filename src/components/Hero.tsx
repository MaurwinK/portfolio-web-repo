          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <MotionWrapper delay={0} animateOnLoad={true}>
                  <p className="text-primary text-lg font-medium tracking-wide">Hello! I'm Maurwin.</p>
                </MotionWrapper>
                <MotionWrapper delay={0.1} animateOnLoad={true}>
              ...
              <MotionWrapper delay={0.2} animateOnLoad={true}>
              ...
              <MotionWrapper delay={0.3} animateOnLoad={true}>
            ...
            {/* Profile Image */}
            <MotionWrapper delay={0.4} animateOnLoad={true} className="flex justify-center lg:justify-end">
